...
const Support = () => {
  return (
    <div name="support" className='w-full mt24'>
        ...
        <div className='max-w-[1240px] mx-auto text-white relative'>
            <div className='px-4 py-12'>
                ...
                <p className='py-4 text-3xl text-slate-300'>
                    ...
                    suscipit explicabo nobis voluptate, neque qui non magni laboriosam quidem.
                </p>
            </div>
                ...
                <div className='bg-white rounded-xl shadow-2xl'>
                    <div className='p-8'>
                        ...
                        <p className='text-gray-600 text-xl'>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem, doloremque. Sint obcaecati similique fugit recusandae ipsa natus laudantium cupiditate at!
                        </p>
                    </div>
